...
alertLoad();
        ...
        loadLineHeat=function(){
            var lineChart = AmCharts.makeChart("lineheat", {
                "type": "serial",
                "theme": "light",
                "marginRight": 80,
                "dataProvider": [{
            ...
            function zoomChart() {
                lineChart.zoomToDates(new Date(2012, 0, 3), new Date(2012, 0, 11));
            }
        }

        toggleMenu=function(){
            $("#menuLink").toggleClass("menuHidden");
        }
alertLoad=function(){
...
downArrow.onclick = function () {
    'use strict';
    document.getElementById("first-list").style = "top:-390px";
    document.getElementById("second-list").style = "top:-390px";
